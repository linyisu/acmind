...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager.create_table(
            Table::create()
                ...
                .primary_key(Index::create().col(ProblemTag::ProblemId).col(ProblemTag::TagId))
                .foreign_key(
                    ForeignKey::create()
        ...
        manager.create_table(
            Table::create()
                ...
                .primary_key(Index::create().col(KnowledgeTag::KnowledgeId).col(KnowledgeTag::TagId))
                .foreign_key(
                    ForeignKey::create()
    ...
    async fn down(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager.drop_table(Table::drop().table(KnowledgeTag::Table).to_owned()).await?;
        manager.drop_table(Table::drop().table(ProblemTag::Table).to_owned()).await
    }
}
