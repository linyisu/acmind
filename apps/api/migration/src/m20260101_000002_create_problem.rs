    ...
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager.create_table(
            Table::create()
                ...
                .col(timestamp_with_time_zone(Problem::CreatedAt).default(Expr::current_timestamp()))
                .col(timestamp_with_time_zone(Problem::UpdatedAt).default(Expr::current_timestamp()))
                .foreign_key(
                    ForeignKey::create()
